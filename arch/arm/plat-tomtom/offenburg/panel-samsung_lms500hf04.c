 ...
 *
 * Power on/off sequence and board glue for the Samsung LMS500HF04 panel
 *
...
static int offenburg_panel_enable_lcd(struct omap_dss_device *dssdev)
{
	...
	/* switch LMS500HF04 to normal mode */
...
static void offenburg_panel_disable_lcd(struct omap_dss_device *dssdev)
{
	...
	/* switch LMS500HF04 to standby mode */
...
struct omap_dss_device offenburg_lms500_lcd_device = {
	.type				= OMAP_DISPLAY_TYPE_DPI,
	.name				= "lcd",
	.driver_name		= "samsung_lms500hf04_panel",
	.phy.dpi.data_lines	= 24,
	.platform_enable	= offenburg_panel_enable_lcd,
	.platform_disable	= offenburg_panel_disable_lcd,
};
EXPORT_SYMBOL(offenburg_lms500_lcd_device);
