...
#define OMAP343X_CONTROL_MEM_RTA	(OMAP2_CONTROL_GENERAL + 0x019C)
...
/* 34xx PADCONF_WKUP pins */
#define OMAP3_PADCONF_I2C4_SCL   (OMAP343X_CONTROL_PADCONFS_WKUP + 0x0)
#define OMAP3_PADCONF_I2C4_SDA   (OMAP343X_CONTROL_PADCONFS_WKUP + 0x2)
...
#define OMAP343X_CONTROL_WKUP_BGAPTS  (OMAP343X_CONTROL_GENERAL_WKUP + 0x028)

/* 36xx-only GENERAL_WKUP register offsets */
#define OMAP36XX_CONTROL_PROG_IO_WKUP1 (OMAP343X_CONTROL_GENERAL_WKUP + 0x024)
#define OMAP36XX_CONTROL_VBBLDO_EFUSE_CTRL (OMAP343X_CONTROL_GENERAL_WKUP + 0X030)
...
/* CONTROL_TEMP_SENSOR bits */
#define OMAP343X_TEMP_CONTCONV		(1 << 10)
#define OMAP343X_TEMP_SOC		(1 << 9)
#define OMAP343X_TEMP_EOCZ		(1 << 8)
#define OMAP343X_TEMP_MASK		(0xff << 0)

/* CONTROL_SPREADING bits */
#define OMAP343X_SPREADING_ENABLE	(1 << 4)

/* CONTROL_WKUP_BGAPTS bits */
#define OMAP343X_BGAPTS_BGROFF		(1 << 2)
#define OMAP343X_BGAPTS_TMPSOFF		(1 << 0)


/* CONTROL_PROG_IO0 bits on omap3630 */
#define OMAP3630_PRG_SDMMC_PUSTRENGTH   (1 << 1) 
...
/* CONTROL_WKUP_CTRL bits */
#define OMAP343X_GPIO_IO_PWRDNZ							(1 << 6)
#define OMAP343X_GPIO_1_IN_SEL_SAD2D_NRESWARM_IN_SEL	(1 << 5)
#define OMAP343X_MM_FSUSB3_TXEN_N_OUT_POLARITY_CTRL		(1 << 2)
#define OMAP343X_MM_FSUSB2_TXEN_N_OUT_POLARITY_CTRL		(1 << 1)
#define OMAP343X_MM_FSUSB1_TXEN_N_OUT_POLARITY_CTRL		(1 << 0) 

/* CONTROL_MEM_RTA bits */
#define OMAP3_MEM_RTA_ENABLE		(1 << 0)
