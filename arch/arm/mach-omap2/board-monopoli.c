...
#include <mach/padconfig_monopoli.h>

#define MONOPOLI_VRAM_SIZE	4
#define MONOPOLI_VRAM_ADDR	0x81020000
...
struct spi_board_info monopoli_ld050wv1sp01_board_info __initdata = {
...
struct spi_board_info monopoli_lms501kf03_board_info __initdata = {
...
struct spi_board_info monopoli_spi_board_info[] __initdata = {
	[0] = {
		.modalias               = "kxr94",
		.bus_num                = 1,
		.chip_select            = 0,
...
static struct regulator_consumer_supply monopoli_vdds_dsi_supply[] = {
	{
		.supply		= "vdds_dsi",
...
static struct regulator_consumer_supply monopoli_vmmc1_supply = {
	.supply			= "vmmc",
};

static struct regulator_consumer_supply monopoli_vmmc2_supply = {
	.supply			= "vmmc",
};

static struct platform_device monopoli_pmic_vgpio;

static int monopoli_twl_gpio_setup(struct device *dev,
		unsigned gpio, unsigned ngpio)
{
	twl4030_mmc_init(mmc);

	monopoli_vmmc1_supply.dev = mmc[0].dev;
	monopoli_vmmc2_supply.dev = mmc[1].dev;

	platform_device_register(&monopoli_pmic_vgpio);
...
static struct twl4030_gpio_platform_data monopoli_gpio_data = {
	.gpio_base	= TWL4030_GPIO_BASE,
	.irq_base	= TWL4030_GPIO_IRQ_BASE,
	.irq_end	= TWL4030_GPIO_IRQ_END,
	.setup		= monopoli_twl_gpio_setup,
};

static struct twl4030_usb_data monopoli_usb_data = {
	.usb_mode	= T2_USB_MODE_ULPI,
};

/* VMMC1 is also used for level shifters !!! */
static struct regulator_init_data monopoli_vmmc1 = {
	.constraints = {
		.min_uV			= 3000000,
		.max_uV			= 3000000,
	...
	.consumer_supplies	= &monopoli_vmmc1_supply,
};

/* VMMC2 is used for powering sensors (not tilt) */
static struct regulator_init_data monopoli_vmmc2 = {
	.constraints = {
		.min_uV			= 3150000,
		.max_uV			= 3150000,
		.valid_modes_mask	= REGULATOR_MODE_NORMAL
	...
	.num_consumer_supplies	= 1,
	.consumer_supplies	= &monopoli_vmmc2_supply,
};

/* VPLL1 for SoC DPLL */
static struct regulator_init_data monopoli_vpll1 = {
	.constraints = {
		.name			= "VDD_1V8_PLL1",
		.min_uV			= 1800000,
		.max_uV			= 1800000,
...
/* on DSI.                                                                    */
static struct regulator_init_data monopoli_vpll2 = {
	.constraints = {
	...
	.num_consumer_supplies	= ARRAY_SIZE(monopoli_vdds_dsi_supply),
	.consumer_supplies	= &monopoli_vdds_dsi_supply[0],
};

/* VAUX1 for i2c3 and TS */
static struct regulator_consumer_supply monopoli_vaux1_supply = {
	.supply			= "vaux1",
	.dev			= NULL,
};

static struct regulator_init_data monopoli_vaux1 = {
	.constraints = {
		.name			= "VDD_3V0_AUX1",
		.min_uV			= 3000000,
		.max_uV			= 3000000,
	...
	.num_consumer_supplies	= 1,
	.consumer_supplies	= &monopoli_vaux1_supply,
};

/* VAUX3 for BC06, BRCM4329, TS, */
static struct regulator_consumer_supply monopoli_vaux3_supply = {
	.supply			= "vaux3",
	.dev			= NULL,
};

static struct regulator_init_data monopoli_vaux3 = {
	.constraints = {
		.name			= "VDD_1V8_AUX3",
		.min_uV			= 1800000,
		.max_uV			= 1800000,
	...
	.num_consumer_supplies	= 1,
	.consumer_supplies	= &monopoli_vaux3_supply,
};

/* VAUX4 for UART, LCM */
static struct regulator_consumer_supply monopoli_vaux4_supply = {
	.supply			= "vaux4",
	.dev			= NULL,
};

static struct regulator_init_data monopoli_vaux4 = {
	.constraints = {
		.name			= "VDD_1V8_AUX4",
		.min_uV			= 1800000,
		.max_uV			= 1800000,
	...
	.num_consumer_supplies	= 1,
	.consumer_supplies	= &monopoli_vaux4_supply,
};

/* VDR_3V Regulator */

static struct regulator_consumer_supply monopoli_pwr_vdr3v_consumers[] = {
	/* Accelerometer (KXR94) */
	{
		.supply		= "VDD",
		.dev_name	= "spi1.0",
...
static struct regulator_init_data monopoli_pwr_vdr3v_init_data = {
	/* .supply_regulator	= we have two of them ... */
	.constraints = {
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
	},
	.num_consumer_supplies = ARRAY_SIZE(monopoli_pwr_vdr3v_consumers),
	.consumer_supplies = monopoli_pwr_vdr3v_consumers,
};

static struct fixed_voltage_config monopoli_pwr_vdr3v_pdata = {
	.supply_name		= "VDR_3V",
	.microvolts		= 3000000,
	.enabled_at_boot	= 0,
	.init_data		= &monopoli_pwr_vdr3v_init_data,
	.gpio			= TT_VPGIO_DR_POWER_EN,
	.enable_high		= 1,
};

static struct platform_device monopoli_pwr_vdr3v_pdev = {
	.name          = "reg-fixed-voltage",
	.id            = -1,
	.dev = {
		.platform_data = &monopoli_pwr_vdr3v_pdata,
	},
};

/* mmc2 (WLAN) and Bluetooth don't use twl4030 regulators */

static struct twl4030_codec_audio_data monopoli_audio_data = {
	.audio_mclk = 26000000,
};

static struct twl4030_codec_data monopoli_codec_data = {
	.audio_mclk = 26000000,
	.audio = &monopoli_audio_data,
};

/* mmc2 (WLAN) and Bluetooth don't use twl4030 regulators */

static struct twl4030_madc_platform_data monopoli_madc_data = {
	.irq_line	= 1,
};
 ...
 */
static struct twl4030_ins __initdata monopoli_sleep_on_seq[] = {
...
static struct twl4030_script monopoli_sleep_on_script __initdata = {
	.script	= monopoli_sleep_on_seq,
	.size	= ARRAY_SIZE(monopoli_sleep_on_seq),
 ...
 */
static struct twl4030_ins monopoli_wakeup_p12_seq[] __initdata = {
...
static struct twl4030_script monopoli_wakeup_p12_script __initdata = {
	.script	= monopoli_wakeup_p12_seq,
	.size	= ARRAY_SIZE(monopoli_wakeup_p12_seq),
 ...
 */
static struct twl4030_ins monopoli_wakeup_p3_seq[] __initdata = {
	/* Broadcast message to put res to active */
	{MSG_BROADCAST(DEV_GRP_ALL, RES_GRP_ALL, RES_TYPE_ALL, RES_TYPE2_R2, RES_STATE_ACTIVE), 2},
};

static struct twl4030_script monopoli_wakeup_p3_script __initdata = {
	.script = monopoli_wakeup_p3_seq,
	.size   = ARRAY_SIZE(monopoli_wakeup_p3_seq),
 ...
 */
static struct twl4030_ins monopoli_wrst_seq[] __initdata = {
/*
...
static struct twl4030_script monopoli_wrst_script __initdata = {
	.script = monopoli_wrst_seq,
	.size   = ARRAY_SIZE(monopoli_wrst_seq),
	.flags  = TWL4030_WRST_SCRIPT,
};

/* TRITON script for sleep, wakeup & warm_reset */
static struct twl4030_script *monopoli_twl4030_scripts[] __initdata = {
	&monopoli_wakeup_p12_script,
	&monopoli_wakeup_p3_script,
	&monopoli_sleep_on_script,
	&monopoli_wrst_script,
};

static struct twl4030_resconfig monopoli_twl4030_rconfig[] = {
...
static struct twl4030_power_data monopoli_t2scripts_data __initdata = {
	.scripts	= monopoli_twl4030_scripts,
	.num		= ARRAY_SIZE(monopoli_twl4030_scripts),
	.resource_config = monopoli_twl4030_rconfig,
};

static struct twl4030_clock_init_data monopoli_clock_data = {
	.clk_slicer_bypass = 1,
	.high_perf_sq_disable = 1,
};

static struct twl4030_platform_data monopoli_twldata = {
	.irq_base	= TWL4030_IRQ_BASE,
	.irq_end	= TWL4030_IRQ_END,
	.clock		= &monopoli_clock_data,
	.gpio		= &monopoli_gpio_data,
	.madc		= &monopoli_madc_data,
	.usb		= &monopoli_usb_data,
	.power		= &monopoli_t2scripts_data,
	.codec		= &monopoli_codec_data,
	/* regulators: */
	.vdac		= NULL, /* not used */
	.vaux1		= &monopoli_vaux1,
	.vaux2		= NULL, /* not used */
	.vaux3		= &monopoli_vaux3,
	.vpll1		= &monopoli_vpll1,
	.vpll2		= &monopoli_vpll2,
	.vmmc1		= &monopoli_vmmc1,
	.vmmc2		= &monopoli_vmmc2,
	.vsim		= NULL,
	.vaux4		= &monopoli_vaux4,
...
static struct i2c_board_info __initdata monopoli_i2c_boardinfo[] = {
	{
		I2C_BOARD_INFO("tps65950", 0x48),
		.flags = I2C_CLIENT_WAKE,
		.irq = INT_34XX_SYS_NIRQ,
		.platform_data = &monopoli_twldata,
	},
};

static void __init monopoli_i2c_init(void)
{
	omap_register_i2c_bus(1, 400, NULL, monopoli_i2c_boardinfo,
			ARRAY_SIZE(monopoli_i2c_boardinfo));
	omap_register_i2c_bus(2, 100, NULL, NULL, 0);
	omap_register_i2c_bus(3, 50, NULL, NULL, 0);
}

static void __init monopoli_init_irq(void)
{
	omap_init_irq();
...
static void monopoli_syson_init(void)
{
	u32 reg;
...
static void monopoli_power_off(void)
{
...
static struct platform_device *monopoli_devices[] __initdata = {
	&offenburg_dss_device,
	&monopoli_pwr_vdr3v_pdev
};
...
struct vgpio_pin monopoli_soc_vgpio_pins[] = {
...
struct vgpio_pin monopoli_pmic_vgpio_pins[] = {
...
static struct vgpio_platform_data monopoli_soc_vgpio_pdata =
{
        .gpio_base      = TT_VGPIO_BASE,
        .gpio_number    = ARRAY_SIZE(monopoli_soc_vgpio_pins),
        .pins           = monopoli_soc_vgpio_pins,
};

static struct platform_device monopoli_soc_vgpio =
{
        .name   = "vgpio",
        .id     = 0,
        .dev    = {
                .platform_data  = &monopoli_soc_vgpio_pdata,
        },
};

static struct vgpio_platform_data monopoli_pmic_vgpio_pdata =
{
        .gpio_base      = TT_PMIC_VGPIO_BASE,
        .gpio_number    = ARRAY_SIZE(monopoli_pmic_vgpio_pins),
        .pins           = monopoli_pmic_vgpio_pins,
};
...
static struct platform_device monopoli_pmic_vgpio =
{
        ...
        .id     = 1,
        .dev    = {
                .platform_data  = &monopoli_pmic_vgpio_pdata,
        },
};
...
static void monopoli_patch_revision(void)
{
	/* no different hw revisions so far */
}

static void __init monopoli_pm_init(void)
{
	int irq;
...
static void __init monopoli_init(void)
{

	omap3_mux_init(board_mux, OMAP_PACKAGE_CBP);

	/* Execute before registering vgpios */
	monopoli_patch_revision();

	platform_device_register(&monopoli_soc_vgpio);
#if defined (CONFIG_TOMTOM_BCM4329) && defined (CONFIG_BCM4329)
	config_bcm4329_power();
#endif
	monopoli_syson_init();
	monopoli_i2c_init();
	platform_add_devices(monopoli_devices, ARRAY_SIZE(monopoli_devices));

	omap_serial_init();
	usb_musb_init(&musb_board_data);

	printk(KERN_INFO "Registering spi board_info\n");
	spi_register_board_info(monopoli_spi_board_info,
		ARRAY_SIZE(monopoli_spi_board_info));

	/* Ensure SDRC pins are mux'd for self-refresh */
	omap_mux_init_signal("sdrc_cke0", OMAP_PIN_OUTPUT);
	omap_mux_init_signal("sdrc_cke1", OMAP_PIN_OUTPUT);

	/* Register Monopoli specific power-off method */
	pm_power_off = monopoli_power_off;
	monopoli_pm_init();
}

static void __init monopoli_map_io(void)
{
	omap_vram_set_sdram_vram (MONOPOLI_VRAM_SIZE*1024*1024, MONOPOLI_VRAM_ADDR);

	omap2_set_globals_343x();
	omap2_map_common_io();
}

MACHINE_START(MONOPOLI, "Monopoli")
	.phys_io	= 0x48000000,
	.io_pg_offst	= ((0xfa000000) >> 18) & 0xfffc,
	.boot_params	= 0x80000100,
	.map_io		= monopoli_map_io,
	.init_irq	= monopoli_init_irq,
	.init_machine	= monopoli_init,
	.timer		= &omap_timer,
MACHINE_END
