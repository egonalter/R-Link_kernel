...
static struct clk gpt10_fck = {
	...
	.clkdm_name	= "core_l4_clkdm",
	.recalc		= &omap2_clksel_recalc,
#if (defined(CONFIG_MACH_STRASBOURG_A2) || defined(CONFIG_MACH_STRASBOURG_XENIA)) && \
	defined(CONFIG_FB_OMAP_BOOTLOADER_INIT)
	/* 
	 * This clock enables the PWM backlight - this is the 
	 * only way to keep it enabled at all times since boot 
	 */
...
static struct omap_clk omap34xx_clks[] = {
	...
	CLK(NULL,	"uart4_fck",	&uart4_fck,	CK_343X),
	...
	CLK(NULL,	"uart4_ick",	&uart4_ick,	CK_343X),
