...
#ifndef PADCONFIG_STRASBOURG_A2_H
#define PADCONFIG_STRASBOURG_A2_H
...
#define PADCONFIG_SETTINGS_XLOADER      \
	...
	PC_DEFINE(CP(SDMMC1_DAT0),   PC_INPUT  | PC_PULL_DIS | PC_PULL_DOWN   | PC_MODE0)                      \
	PC_DEFINE(CP(SDMMC1_DAT1),   PC_INPUT  | PC_PULL_DIS | PC_PULL_DOWN   | PC_MODE0)                      \
	PC_DEFINE(CP(SDMMC1_DAT2),   PC_INPUT  | PC_PULL_DIS | PC_PULL_DOWN   | PC_MODE0)                      \
	PC_DEFINE(CP(SDMMC1_DAT3),   PC_INPUT  | PC_PULL_DIS | PC_PULL_DOWN   | PC_MODE0)                      \
                                                                                                               \
	/* USB0 lines */                                                                                       \
...
/* LCD lines */                                                                                        \
	...
	PC_DEFINE(CP(GPMC_WAIT3),    PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4) /* BACKLIGHT_ON */     \
...
#define PADCONFIG_SETTINGS_KERNEL       \
	/* UART1 lines */                                                                                      \
	PC_DEFINE(CP(UART1_CTS),     PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW) /* GPS_RTS_SOC_CTS */  \
	PC_DEFINE(CP(UART1_RTS),     PC_INPUT  | PC_PULL_ENA | PC_PULL_UP   | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW) /* GPS_CTS_SOC_RTS */  \
	PC_DEFINE(CP(UART1_RX),      PC_INPUT  | PC_PULL_ENA | PC_PULL_UP   | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW) /* GPS_TX_SOC_RX */    \
	PC_DEFINE(CP(UART1_TX),      PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW) /* GPS_RX_SOC_TX */    \
                                                                                                               \
	/* UART2 lines */                                                                                      \
	PC_DEFINE(CP(MCBSP3_CLKX),   PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE1 | OMAP_PIN_OFF_OUTPUT_LOW) /* BT_RX */            \
	PC_DEFINE(CP(MCBSP3_FSX),    PC_INPUT  | PC_PULL_ENA | PC_PULL_UP   | PC_MODE1 | OMAP_PIN_OFF_OUTPUT_LOW) /* BT_TX */            \
                                                                                                               \
	/* MCBSP1 lines */                                                                                     \
	PC_DEFINE(CP(MCBSP1_CLKX),   PC_INPUT  | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW) /* BT_PCM_CLK */       \
	PC_DEFINE(CP(MCBSP1_DR),     PC_INPUT  | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW) /* BT_PCM_OUT */       \
	PC_DEFINE(CP(MCBSP1_DX),     PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW) /* BT_PCM_IN  */       \
	PC_DEFINE(CP(MCBSP1_FSX),    PC_INPUT  | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW) /* BT_PCM_SYNC */      \
	                                                                                                       \
	/* USB2 lines */                                                                                       \
	...
	PC_DEFINE(CP(JTAG_TDO),      PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE0) /* uP_TDO */           \
                                                                                                           \
	/* GPIO lines */                                                                                       \
	PC_DEFINE(CP(CAM_WEN),       PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* GPS_CORE_PWR_EN */  \
	PC_DEFINE(CP(CAM_XCLKA),     PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* CAM_PWR_ON */       \
	PC_DEFINE(CP(SDMMC2_DAT1),   PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* nCAM_RST */         \
	PC_DEFINE(CP(GPMC_NBE0_CLE), PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* nBT_RST */          \
	PC_DEFINE(CP(MCBSP_CLKS),    PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* nGPS_RESET */       \
	PC_DEFINE(CP(UART3_RTS_SD),  PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* GPS_HOST_REQ */     \
	PC_DEFINE(CP(GPIO126),       PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* nAUTH_RST */        \
	PC_DEFINE(CP(GPIO129),       PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* CAM_ON */           \
...
#define PADCONFIG_SETTINGS_COMMON       \
	...
	PC_DEFINE(CP(GPMC_NWE),      PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE0) /* GPMC_nWE */         \
                                                                                                               \
	/* MCBSP4 lines */                                                                                     \
	PC_DEFINE(CP(GPMC_NCS4),     PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE2 | OMAP_PIN_OFF_OUTPUT_LOW) /* MCBSP4_CLK */       \
	PC_DEFINE(CP(GPMC_NCS6),     PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE2 | OMAP_PIN_OFF_OUTPUT_LOW) /* MCBSP4_DX */        \
	PC_DEFINE(CP(GPMC_NCS7),     PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE2 | OMAP_PIN_OFF_OUTPUT_LOW) /* MCBSP4_FSX */       \
                                                                                                               \
	/* I2C lines */                                                                                        \
	...
	PC_DEFINE(CP(I2C1_SDA),      PC_INPUT  | PC_PULL_ENA | PC_PULL_UP   | PC_MODE0)                        \
                                                                                                               \
	/* MCBSP2 lines */                                                                                     \
	PC_DEFINE(CP(MCBSP2_CLKX),   PC_INPUT  | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_INPUT_NOPULL) /* MCBSP2_CLK */       \
	PC_DEFINE(CP(MCBSP2_DR),     PC_INPUT  | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_INPUT_NOPULL) /* MCBSP2_DR */        \
	PC_DEFINE(CP(MCBSP2_DX),     PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW)   /* MCBSP2_DX */        \
	PC_DEFINE(CP(MCBSP2_FSX),    PC_INPUT  | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_INPUT_NOPULL) /* MCBSP2_FSX */       \
                                                                                                               \
	/* MCSPI1 lines */                                                                                     \
	PC_DEFINE(CP(MCSPI1_CLK),    PC_INPUT  | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW) /* SPI_CAN_CLK */      \
	PC_DEFINE(CP(MCSPI1_SIMO),   PC_INPUT  | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW) /* SPI_CAN_SIMO */     \
	PC_DEFINE(CP(MCSPI1_SOMI),   PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW) /* SPI_CAN_SOMI */     \
	PC_DEFINE(CP(MCSPI1_CS0),    PC_INPUT  | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW) /* SPI_CAN_CS0 */      \
                                                                                                               \
	/* MCSPI3 lines */                                                                                     \
	PC_DEFINE(CP(SDMMC2_CLK),    PC_INPUT   | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE1 | OMAP_PIN_OFF_OUTPUT_LOW) /* MCSPI3_CLK */      \
	PC_DEFINE(CP(SDMMC2_CMD),    PC_OUTPUT  | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE1 | OMAP_PIN_OFF_OUTPUT_LOW) /* MCSPI3_SIMO */     \
	PC_DEFINE(CP(SDMMC2_DAT0),   PC_INPUT   | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE1 | OMAP_PIN_OFF_OUTPUT_LOW) /* MCSPI3_SOMI */     \
	PC_DEFINE(CP(SDMMC2_DAT3),   PC_OUTPUT  | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE1 | OMAP_PIN_OFF_OUTPUT_LOW) /* MCSPI3_CS0 */      \
	                                                                                                       \
	/* SYS lines */                                                                                        \
	...
	PC_DEFINE(CP(SYS_OFF_MODE),  PC_INPUT  | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE0) /* SYS_OFF_MODE */     \
                                                                                                               \
	/* UART3 lines */                                                                                      \
	PC_DEFINE(CP(UART3_RX_IRRX), PC_INPUT  | PC_PULL_ENA | PC_PULL_UP   | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW) /* DEBUG_RX */         \
	PC_DEFINE(CP(UART3_TX_IRTX), PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE0 | OMAP_PIN_OFF_OUTPUT_LOW) /* DEBUG_TX */         \
	                                                                                                       \
	/* BACKLIGHT_PWM */                                                                                    \
	PC_DEFINE(CP(GPMC_NCS5),     PC_INPUT | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE3)  /* BACKLIGHT_PWM */    \
	                                                                                                       \
	/* Unused lines */                                                                         \
	...
	PC_DEFINE(CP(CAM_D10),       PC_INPUT | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE4) /* CAM_D10 as GPIO */    \
	...
	PC_DEFINE(CP(MCBSP4_DX),     PC_INPUT | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE4) /* MCBSP4_DX as GPIO */  \
	PC_DEFINE(CP(MCBSP4_FSX),    PC_INPUT | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE4) /* MCBSP4_FSX as GPIO */ \
	...
	PC_DEFINE(CP(CSI2_DY1),      PC_INPUT | PC_PULL_ENA | PC_PULL_DOWN | PC_MODE4) /* CSI2_DY1 as GPIO */   \
                                                                                                            \
	/* GPIO lines */                                                                                        \
	PC_DEFINE(CP(CAM_D8),        PC_INPUT  | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* nCAM_IRQ */         \
	PC_DEFINE(CP(CAM_D9),        PC_INPUT  | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4) /* nGPS_ANT_SHORT */   \
	PC_DEFINE(CP(CAM_D11),       PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* nUSB2_RESET */      \
	PC_DEFINE(CP(CAM_XCLKB),     PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* MIC_ON */           \
	PC_DEFINE(CP(SDMMC2_DAT4),   PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* nCAN_RST */         \
	PC_DEFINE(CP(SDMMC2_DAT5),   PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* LCM_PWR_ON */       \
	PC_DEFINE(CP(SDMMC2_DAT6),   PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* GPS_TCXO_ON */      \
	PC_DEFINE(CP(SDMMC2_DAT7),   PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* nCAN_IRQ */         \
	PC_DEFINE(CP(GPMC_A8),       PC_INPUT  | PC_PULL_ENA | PC_PULL_UP   | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* nDIAGSYS_BOOT */    \
	PC_DEFINE(CP(GPMC_A9),       PC_INPUT  | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* GPS_1PPS */         \
	PC_DEFINE(CP(GPMC_NCS3),     PC_INPUT  | PC_PULL_ENA | PC_PULL_UP   | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* nTP_IRQ */          \
	PC_DEFINE(CP(GPMC_WAIT3),    PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* BACKLIGHT_ON  */    \
	PC_DEFINE(CP(HDQ_SIO),       PC_INPUT  | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* CAN_RST_MON */      \
	...
	PC_DEFINE(CP(MCBSP1_CLKR),   PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* nLCD_RESET */       \
	PC_DEFINE(CP(MCBSP1_FSR),    PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* nTP_RESET */        \
	PC_DEFINE(CP(SYS_CLKOUT1),   PC_INPUT  | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4) /* nON_OFF */          \
	PC_DEFINE(CP(SYS_CLKOUT2),   PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* CAN_BT_MD */        \
	PC_DEFINE(CP(UART3_CTS_RCTX),PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* CAN_SYNC */         \
	PC_DEFINE(CP(MCBSP3_DR),     PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* USB1_SPEED */       \
	PC_DEFINE(CP(MCBSP3_DX),     PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* USB1_SUSPEND */     \
	PC_DEFINE(CP(ETK_CLK),       PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* LCD_UD */           \
	PC_DEFINE(CP(ETK_D5),        PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* LCD_LR */           \
	PC_DEFINE(CP(ETK_D3),        PC_INPUT  | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE4 | OMAP_PIN_OFF_OUTPUT_LOW) /* SENSE_11V0 */       \
	
#endif // PADCONFIG_STRASBOURG_A2_H
