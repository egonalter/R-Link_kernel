...
#define PADCONFIG_SETTINGS_COMMON_STUTTGART_B1    \
	...
	PC_DEFINE(CP(GPMC_NCS6),     PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE2 | PC_OFF_OUT_LOW) /* MCBSP4_DX */        \
	...
	PC_DEFINE(CP(MCBSP2_DX),     PC_OUTPUT | PC_PULL_DIS | PC_PULL_DOWN | PC_MODE0 | PC_OFF_OUT_LOW)   /* MCBSP2_DX */        \
