...
static struct omap_mux __initdata omap3_muxmodes[] = {
	...
	_OMAP3_MUXENTRY(GPIO126, 126,
		"gpio_126", NULL, NULL, NULL,
		"gpio_126", NULL, NULL, "safe_mode"),
	_OMAP3_MUXENTRY(GPIO127, 127,
		"gpio_127", NULL, NULL, NULL,
		"gpio_127", NULL, NULL, "safe_mode"),
	_OMAP3_MUXENTRY(GPIO129, 129,
		"gpio_129", NULL, NULL, NULL,
	...
	_OMAP3_MUXENTRY(GPMC_NOE, 0,
		"gpmc_noe", NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(GPMC_NADV_ALE, 0,
		"gpmc_nadv_ale", NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(GPMC_NWE, 0,
		"gpmc_nwe", NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	...
	_OMAP3_MUXENTRY(I2C1_SCL, 0,
		"i2c1_scl", NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(I2C1_SDA, 0,
		"i2c1_sda", NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	...
	_OMAP3_MUXENTRY(I2C4_SDA, 0,
		...
		NULL, NULL, NULL, "safe_mode"),
	_OMAP3_MUXENTRY(JTAG_NTRST, 0,
		"jtag_ntrst", NULL, NULL, NULL,
		NULL, NULL, NULL,NULL),
	_OMAP3_MUXENTRY(JTAG_TCK, 0,
		"jtag_tck", NULL, NULL, NULL,
		NULL, NULL, NULL,NULL),
	_OMAP3_MUXENTRY(JTAG_TMS_TMSC, 0,
		"jtag_tms_tmsc", NULL, NULL, NULL,
		NULL, NULL, NULL,NULL),
	_OMAP3_MUXENTRY(JTAG_TDI, 0,
		"jtag_tdi", NULL, NULL, NULL,
		NULL, NULL, NULL,NULL),
	_OMAP3_MUXENTRY(JTAG_TDO, 0,
		"jtag_tdo", NULL, NULL, NULL,
		NULL, NULL, NULL,NULL),
	_OMAP3_MUXENTRY(JTAG_RTCK, 0,
		"jtag_rtck", NULL, NULL, NULL,
		NULL, NULL, NULL,NULL),
...
struct omap_ball __initdata omap3_cus_ball[] = {
	...
	_OMAP3_BALLENTRY(GPMC_NCS0, "e2", NULL),
	...
	_OMAP3_BALLENTRY(GPMC_NOE, "f2", NULL),
	_OMAP3_BALLENTRY(GPMC_NADV_ALE, "f1", NULL),
	_OMAP3_BALLENTRY(GPMC_NWE, "g3", NULL),
	...
	_OMAP3_BALLENTRY(I2C1_SCL, "k20", NULL),
	_OMAP3_BALLENTRY(I2C1_SDA, "k21", NULL),
	...
	_OMAP3_BALLENTRY(JTAG_NTRST, "ab7", NULL),
	_OMAP3_BALLENTRY(JTAG_TCK, "ab6", NULL),
	_OMAP3_BALLENTRY(JTAG_RTCK, "aa7", NULL),
	_OMAP3_BALLENTRY(JTAG_TMS_TMSC, "aa9", NULL),
	_OMAP3_BALLENTRY(JTAG_TDI, "ab10", NULL),
	_OMAP3_BALLENTRY(JTAG_TDO, "ab9", NULL),
...
struct omap_ball __initdata omap3_cbb_ball[] = {
	...
	_OMAP3_BALLENTRY(GPIO126, "n22", NULL),
	_OMAP3_BALLENTRY(GPIO127, "r27", NULL),
	_OMAP3_BALLENTRY(GPIO129, "p24", NULL),
