...
#elif defined(CONFIG_CPU_S3C6400) || defined(CONFIG_CPU_S3C6410) || defined(CONFIG_ARCH_S5P6440) || defined(CONFIG_CPU_S5PC100) || defined(CONFIG_CPU_S5PC110)
...
#if defined(CONFIG_CPU_S5PC110) // ksoo add
#define S3C_WPALCON_H		S3C_LCDREG(0x19C)	/* Window Palette control register	*/
#define S3C_WPALCON_L		S3C_LCDREG(0x1A0)	/* Window Palette control register	*/
#else
