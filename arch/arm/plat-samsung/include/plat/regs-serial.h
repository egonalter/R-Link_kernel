...
#define S3C24XX_VA_UART4      (S3C_VA_UART + 0x1000)
#define S3C24XX_VA_UART5      (S3C_VA_UART1 )
...
#define S3C2410_PA_UART4      (S3C24XX_PA_UART + 0x1000 )
#define S3C2410_PA_UART5      (S3C24XX_PA_UART + 0x0000 )
...
#define S3C2410_UCON_TXDMAMODE_SIG1     (3 << 2)
...
#define S3C6450_UFSTAT4_TXFULL	  (1<<24)
#define S3C6450_UFSTAT4_RXFULL	  (1<<8)
#define S3C6450_UFSTAT4_TXSHIFT	  (16)
#define S3C6450_UFSTAT4_RXSHIFT	  (0)
#define S3C6450_UFSTAT4_TXMASK	  (255<<16)
#define S3C6450_UFSTAT4_RXMASK	  (255)
...
extern struct platform_device *s3c24xx_uart_devs[6];
