/* linux/arch/arm/plat-samsung/include/plat/dma-s5p.h
 *
 * Copyright (c) 2010 Samsung Electronics Co., Ltd.
 *		http://www.samsung.com/
 *
 * Based on arch/arm/plat-samsung/include/plat/dma-s3c24xx.h
 * Copyright (C) 2006 Simtec Electronics
 *	Ben Dooks <ben@simtec.co.uk>
 *
 * Samsung 5P DMA support - per SoC functions
 *
...
#ifndef __ASM_PLAT_DMA_S5P_H
#define __ASM_PLAT_DMA_S5P_H __FILE__
...
extern int s5p_dma_order_set(struct s5p_dma_order *map);
