...
#define S3C_IRQ(x)              ((x) + S5P_IRQ_OFFSET)
...
#define S5P_UART_IRQ(x)         ((x) + S5P_IRQ(100))
...
#define IRQ_S5P_UART_BASE0	S5P_UART_IRQ(0)
#define IRQ_S5P_UART_BASE1	S5P_UART_IRQ(4)
#define IRQ_S5P_UART_BASE2	S5P_UART_IRQ(8)
#define IRQ_S5P_UART_BASE3	S5P_UART_IRQ(12)
#define IRQ_S5P_UART_BASE4     	S5P_UART_IRQ(16)
#define IRQ_S5P_UART_BASE5     	S5P_UART_IRQ(20)
...
#define S5P_TIMER_IRQ(x)	S5P64XX_TIMER_IRQ(x)
...
//#define S5P64XX_TIMER_IRQ(x)    S3C_IRQ(100 + (x))
#define S5P64XX_TIMER_IRQ(x)    (2 + (x))
...
#define S5P_GPIO_IRQ(x)         ((x) + S5P_IRQ(130))
