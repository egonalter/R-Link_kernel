...
static struct map_desc s5p_iodesc[] __initdata = {
	{
		...
		.type		= MT_DEVICE,
                ...
                .pfn            = __phys_to_pfn(S3C_PA_UART5),
                .length         = SZ_4K,
                .type           = MT_DEVICE,
        }, {
		...
		.virtual	= (unsigned long)S5P_VA_OTG,
        ...
        },
	{
		...
		.pfn		= __phys_to_pfn(S5P_PA_GPS),
		.length		= SZ_4K,
		.type		= MT_DEVICE,
	},
	{
		.virtual	= (unsigned long)S3C_VA_NAND,
		.pfn		= __phys_to_pfn(S5P_PA_NAND),
		.length		= SZ_4K,
		.type		= MT_DEVICE,
	},
