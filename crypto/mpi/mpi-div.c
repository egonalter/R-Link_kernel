...
int
mpi_fdiv_r( MPI rem, cMPI dividend, cMPI divisor )
{
	int rc = -ENOMEM;
...
int
mpi_fdiv_q( MPI quot, cMPI dividend, cMPI divisor )
{
...
int
mpi_fdiv_qr( MPI quot, MPI rem, cMPI dividend, cMPI divisor )
{
    int divisor_sign = divisor->sign;
    MPI temp_divisor = NULL;
...
int
mpi_tdiv_r( MPI rem, cMPI num, cMPI den)
{
    return mpi_tdiv_qr(NULL, rem, num, den );
}

int
mpi_tdiv_qr( MPI quot, MPI rem, cMPI num, cMPI den)
{
	int rc = -ENOMEM;
	mpi_ptr_t np, dp;
	mpi_ptr_t qp, rp;
