...
#if defined (CONFIG_CPU_S5PV210) || defined (CONFIG_CPU_S5P6450)
...
#if defined(CONFIG_CPU_S5P6450)
#define S3C_SPI_PA_SPI0 S5P6450_PA_SPI0
#define S3C_SPI_PA_SPI1 S5P6450_PA_SPI1
#endif
...
#define SET_GPIOPULL(sspi, n)	do{                                           		\
                  if(sspi->cur_mode & SPI_READY){              					   \
                       ...
                       s3c_gpio_setpull(GPNAME(GPMOSI_##n), S3C_GPIO_PULL_NONE);     \
                       s3c_gpio_setpull(GPNAME(GPMISO_##n), S3C_GPIO_PULL_NONE);   \
