...
static struct wake_lock madc_lock;
...
static int __init twl4030_madc_probe(struct platform_device *pdev)
{
	...
	/* Enable MADC clock (freq = ((HFCLK = 26MHz) / 26)) */
	ret = twl_i2c_read_u8(TWL4030_MODULE_INTBR, &regval, TWL4030_INTBR_GPBR1);
	regval |= TWL4030_MADC_HFCLK_EN | TWL4030_DEFAULT_MADC_CLK_EN;
	ret = twl_i2c_write_u8(TWL4030_MODULE_INTBR, regval, TWL4030_INTBR_GPBR1);
	...
	wake_lock_init(&madc_lock, WAKE_LOCK_SUSPEND, "madc_wake_lock");
