				    ...
				    struct s3c24xx_uart_clksrc *clk)
{
	...
	else if (strcmp(clk->name, "clk_pclk66") == 0) {
...
static struct s3c24xx_uart_info s3c6450_uart4_inf = {
	.name		= "Samsung S3C6400 UART",
	.type		= PORT_S3C6400,
	.fifosize	= 256,
	.has_divslot	= 1,
	.rx_fifomask	= S3C6450_UFSTAT4_RXMASK,
	.rx_fifoshift	= S3C6450_UFSTAT4_RXSHIFT,
	.rx_fifofull	= S3C6450_UFSTAT4_RXFULL,
	.tx_fifofull	= S3C6450_UFSTAT4_TXFULL,
	.tx_fifomask	= S3C6450_UFSTAT4_TXMASK,
	.tx_fifoshift	= S3C6450_UFSTAT4_TXSHIFT,
	.get_clksrc	= s3c6400_serial_getsource,
	.set_clksrc	= s3c6400_serial_setsource,
	.reset_port	= s3c6400_serial_resetport,
};
...
static int s3c6400_serial_probe(struct platform_device *dev)
{
	...
	if(dev->id == 4){
		return s3c24xx_serial_probe(dev, &s3c6450_uart4_inf);
	}
	else
