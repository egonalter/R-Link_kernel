...
#ifdef CONFIG_PM
struct mshci_registers {
	unsigned int ctrl_reg;
	unsigned int clkdiv_reg;
	unsigned int clksrc_reg;
	unsigned int clkena_reg;
	unsigned int tmout_reg;
	unsigned int ctype_reg;
	unsigned short blksiz_reg;
