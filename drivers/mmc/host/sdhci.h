...
#ifdef CONFIG_PM
struct sdhci_registers {
	unsigned short blksize_reg;
	unsigned char hostctl_reg;
	unsigned char pwrcon_reg;
	unsigned short clkcon_reg;
	unsigned char timeoutcon_reg;
	unsigned short norintstsen_reg;
	unsigned short errintstsen_reg;
	unsigned short norintsigen_reg;
	unsigned short errintsigen_reg;
	unsigned int control2_reg;
	unsigned int control3_reg;
	unsigned int control4_reg;
};
