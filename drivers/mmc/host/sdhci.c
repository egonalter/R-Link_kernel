...
static void sdhci_set_ios(struct mmc_host *mmc, struct mmc_ios *ios)
{
	...
	/* MMC Workaround :-
 	*	We dont set the High speed bit of Host in the case of MMC card
 	* 	We check ios->timing only for MMC_TIMING_SD_HS,
 	* 	if it is MMC_TIMING_MMC_HS, we clear High speed bit
 	* 	in both case, we switch the card to HS using CMD6            */
