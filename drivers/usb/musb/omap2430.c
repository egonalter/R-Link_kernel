...
int musb_platform_suspend(struct musb *musb)
{
	...
	/* omap36xx errata ID:i445 - HS USB OTG software reset is not 
	 * fully functional. Performing a reset through the SOFT_RST
	 * register of the MUSB controller.
	 */
	musb_writeb(musb->mregs, MUSB_SOFT_RST,
				MUSB_SOFT_RST_NRST | MUSB_SOFT_RST_NRSTX);
