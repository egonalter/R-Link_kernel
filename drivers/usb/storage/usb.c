...
/* Workqueue for delayed SCSI-device scanning */
static struct workqueue_struct *usb_scan_wq;
...
int usb_stor_probe2(struct us_data *us)
{
	...
	queue_delayed_work(usb_scan_wq, &us->scan_dwork,
			delay_use * HZ);
	return 0;
...
static int __init usb_stor_init(void)
{
	...
	usb_scan_wq = create_freezeable_workqueue("usb-stor-scan");
	if (!usb_scan_wq)
		return -ENOMEM;
