...
#if (defined CONFIG_USB_ANDROID_ADC || defined CONFIG_USB_ANDROID_VDC || defined CONFIG_USB_ANDROID_HIDC || \
     defined CONFIG_USB_ANDROID_PANEL || defined CONFIG_USB_ANDROID_KEYBOARD || defined CONFIG_USB_ANDROID_NMEA || \
     defined CONFIG_USB_ANDROID_LIGHTSENSOR || defined CONFIG_USB_ANDROID_POSITIONINGSENSOR || \
     defined CONFIG_USB_ANDROID_ROUTEINSTRUCTION )
					config->interface[interfaceCount] = f;
#endif
