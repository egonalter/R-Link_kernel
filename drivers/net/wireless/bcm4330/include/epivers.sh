...
#
# $Id: epivers.sh 241914 2011-02-20 03:11:27Z prakashd $
# 
...
if [ -f epivers.h ]; then
	...
	SVNURL='$HeadURL: http://svn.sj.broadcom.com/svn/wlansvn/proj/tags/FALCON/FALCON_REL_5_90_125_16/src/include/epivers.sh $'
